 ...
 */
export const createTable = pgTableCreator((name) => `drizz_${name}`);
...
export const notes = createTable(
  ...
  (example) => ({
    createdByIdIdx: index("notes_created_by_idx").on(example.createdById),
...
export const photos = createTable(
  ...
  (example) => ({
    createdByIdIdx: index("photos_created_by_idx").on(example.createdById),
  })
);
